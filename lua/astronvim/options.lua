...
local options = astronvim.user_opts("options", {
  ...
  g = {
    ...
    git_worktrees = {
      { toplevel = vim.env.HOME, gitdir=vim.env.HOME .. "~/repos/worktrees/client.git" },
      { toplevel = vim.env.HOME, gitdir=vim.env.HOME .. "~/repos/worktrees/apm-insight-collector.git" },
    }, -- enable git integration for detached worktrees (specify a table where each entry is of the form { toplevel = vim.env.HOME, gitdir=vim.env.HOME .. "/.dotfiles" })
  },
